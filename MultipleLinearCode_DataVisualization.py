...
# data=data[data['LocationAbbr'].str.contains("US")==True]

# data=data[data['Total'].str.contains("Total")==True]
...
# plt.scatter(data4['col1'],data4['col2']),plt.title("Obesity Rates in US Yearwise"),plt.xlabel('Year'),plt.ylabel('Obesity rate in %')
